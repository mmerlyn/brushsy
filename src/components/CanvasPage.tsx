...
const CanvasPage: React.FC<CanvasPageProps> = ({
    ...
    return (
        <div className="relative group w-full max-w-4xl px-2 sm:px-4">
            <div className={`absolute -top-6 left-1/2 -translate-x-1/2 flex items-center gap-2 sm:gap-3`}>
                <div className={`px-3 py-1 rounded-full transition-all text-xs sm:text-sm ${
                ...
                {pageIndex === state.activePageIndex && (
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gradient-to-r from-purple-500 to-fuchsia-500 rounded-full animate-pulse" />
                )}
            </div>
            ...
            <div
                ...
                className={`mt-4 relative ${themeClasses.shadow} rounded-lg sm:rounded-2xl overflow-hidden bg-white border-2 sm:border-4 ${
                    pageIndex === state.activePageIndex
                        ? 'border-purple-200 ring-2 sm:ring-4 ring-purple-500/30'
                        : 'border-gray-200'
            ...
            {pageIndex === state.pages.length - 1 && (
                <div className="mt-8 sm:mt-12 flex justify-center">
                    ...
                    >
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-600 to-fuchsia-600 rounded-full flex items-center justify-center group-hover:rotate-90 transition-transform duration-300 shadow-lg shadow-purple-500/25">
